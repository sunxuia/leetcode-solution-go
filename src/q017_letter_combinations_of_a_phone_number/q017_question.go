...
func doTest(t *testing.T, method func(string) []string) {
	...
	res = method("23")
	th.AssertEqual([]string{"ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"}, res)

	res = method("234")
	th.AssertEqual([]string{"adg", "adh", "adi", "aeg", "aeh", "aei", "afg", "afh", "afi", "bdg", "bdh", "bdi", "beg", "beh", "bei", "bfg", "bfh", "bfi", "cdg", "cdh", "cdi", "ceg", "ceh", "cei", "cfg", "cfh", "cfi"}, res)
}
